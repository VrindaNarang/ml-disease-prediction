...
import { Box, Chip, IconButton, Paper, Skeleton, Stack, Tab, Tabs, Typography } from '@mui/material'
...
function ExplanationSection({
  ...
  if (loading) {
    return <Skeleton variant="rectangular" height={140} sx={{ mb: 3, borderRadius: 1 }} />
  }
  ...
  return (
    <>
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2 }}>
        <IconButton onClick={() => navigate('/customers')} size="small" aria-label="Back to customers">
