  ...
  return (
    <>
      <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
        Which colleges are most likely to order in the next 30 days, and how much they're
        expected to spend — ranked so outreach effort goes to the highest-value opportunities first.
      </Typography>
      ...
      <Stack direction={{ xs: 'column', md: 'row' }} spacing={2} sx={{ mb: 2.5 }} alignItems={{ md: 'center' }}>
        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} flexWrap="wrap" useFlexGap sx={{ flexGrow: 1 }}>
          <SelectFilter
            label="State"
            value={state}
            onChange={setState}
